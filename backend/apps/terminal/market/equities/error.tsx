...
/**
 * equities/error.tsx
 * Zero-import error boundary UI for the Equities section.
 * - Friendly copy, optional technical dump
 * - Retry (Next.js `reset`) / Reload / Back actions
 * - Tailwind + inline SVG only
 */

export default function EquitiesError({
  error,
  reset,
}: {
  ...
  const msg =
    ...
    "Something went wrong while loading equities data.";
    ...
    <div className="flex min-h-screen items-center justify-center bg-neutral-950 text-neutral-100">
      <div className="w-full max-w-md rounded-xl border border-neutral-800 bg-neutral-900 p-6 shadow-lg">
        <div className="mb-3 flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold">Equities Module Error</h1>
        </div>
