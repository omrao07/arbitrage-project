...
class ChinaMacroModel:
    ...
    def run_model(self):
        # Load macroeconomic indicators for China
        macro_data = load_macro_data("china_macro.csv")
        ...
        # Step 4: Return final position allocations
        positions = self.executor.execute(adjusted_weights)
        return positions

# Optional run
if __name__ == "__main__":
    model = ChinaMacroModel()
    final_positions = model.run_model()
    print("China Allocation:", final_positions)